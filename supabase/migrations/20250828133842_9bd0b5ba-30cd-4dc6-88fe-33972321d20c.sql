...
-- Atualizar enum de status para incluir estado intermediário
ALTER TYPE IF EXISTS pallet_status ADD VALUE IF NOT EXISTS 'alocado_pendente_confirmacao';
...
-- Alterar coluna status para usar o novo tipo
ALTER TABLE public.pallet_positions 
