-- Corrigir a função complete_pallet_allocation_and_create_stock para usar a nova constraint
...
BEGIN
    ...
    LOOP
        ...
        ELSE
            -- Create new stock entry (WITHOUT ON CONFLICT clause since we check for duplicates above)
