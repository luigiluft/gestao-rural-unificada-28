...
-- 1. Fix fornecedores policy for admins
...
-- 2. Fix get_producer_available_deposits to return ALL active franchises
-- This ensures the identified franchise from XML appears in the selector
...
-- 3. Allow admins to manage entrada_itens for any user
...
-- 4. Allow admins to manage entradas for any user  
