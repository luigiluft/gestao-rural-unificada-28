-- Remove unique index from estoque table
DROP INDEX IF EXISTS idx_estoque_unique;

-- Update create_stock_from_pallet function to use simple INSERT without ON CONFLICT
