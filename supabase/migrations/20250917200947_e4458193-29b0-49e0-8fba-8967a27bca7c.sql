...
DROP VIEW IF EXISTS public.estoque CASCADE;

-- 2. Criar view materializada baseada exclusivamente em movimentacoes
...
-- 4. Nova função get_estoque_seguro baseada na view materializada
...
-- 5. Função para refresh da view materializada
...
-- 6. Triggers para refresh automático da view
...
-- 7. Popular a view materializada com dados iniciais
