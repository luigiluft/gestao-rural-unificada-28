-- Fix the create_stock_from_pallet function to use correct ON CONFLICT syntax for unique index
...
BEGIN
  ...
  LOOP
    -- Create or update stock using correct ON CONFLICT syntax for unique index
    -- Use the actual column combination that makes the index unique
    INSERT INTO estoque (
      user_id,
      produto_id,
      deposito_id,
