-- Corrigir função franqueado_can_view_producer para usar get_estoque_from_movimentacoes
...
-- Atualizar políticas RLS na tabela profiles para melhor acesso entre franqueados e produtores
