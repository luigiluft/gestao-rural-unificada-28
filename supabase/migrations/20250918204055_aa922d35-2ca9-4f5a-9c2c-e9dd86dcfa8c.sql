-- CORREÇÕES DEFINITIVAS PARA SISTEMA DE CADASTRO - VERSÃO FINAL CORRIGIDA

-- ============================================================================
-- 1. MELHORAR complete_invite_signup COM TRATAMENTO ROBUSTO
-- ============================================================================
...
-- ============================================================================
-- 4. FUNÇÃO DE DIAGNÓSTICO SIMPLIFICADA PARA TROUBLESHOOTING
-- ============================================================================
...
-- ============================================================================
-- 5. ADICIONAR RLS POLICY PARA LEITURA DE PENDING_INVITES
-- ============================================================================

-- Drop existing policy if it exists
DROP POLICY IF EXISTS "Allow system functions to read invites" ON public.pending_invites;

-- Create new policy for system functions to read invites
CREATE POLICY "Allow system functions to read invites"
...
-- Log final
SELECT 'SISTEMA DE CADASTRO: Todas as correções definitivas foram aplicadas com sucesso!' AS status;