...
export function AgendamentoSectionSimplified({ dados, onDadosChange, pesoTotal, pesoMinimoMopp }: AgendamentoSectionProps) {
    ...
    <Card>
      <CardHeader className="pb-3">
        <CardTitle className="text-lg flex items-center gap-2">
          ...
          Agendamento da {dados.tipo_saida === 'retirada_deposito' ? 'Retirada' : 'Entrega'}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {dados.tipo_saida === 'retirada_deposito' && dados.data_saida && (
          <div className="space-y-4 pt-4 border-t">
            <h4 className="font-medium text-sm">Dados do Veículo de Retirada</h4>
