...
export const tutorialSteps: TutorialStep[] = [
  ...
  {
    id: 'modal-planejamento-visao-geral',
    title: 'Modal de Planejamento de Pallets',
    description: 'Este é o modal de planejamento de pallets. Aqui você pode visualizar os produtos da entrada e configurar como eles serão distribuídos nos pallets.',
    page: '/demo/recebimento',
  ...
  },
  {
    ...
    title: 'Produtos da Entrada',
    description: 'Esta seção mostra todos os produtos que chegaram na entrada atual. Você pode ver a quantidade, código e unidade de cada produto.',
    page: '/demo/recebimento',
  ...
  },
  {
    ...
    title: 'Configuração de Pallets',
    description: 'Aqui você vê como os produtos foram organizados nos pallets. Cada pallet mostra sua capacidade utilizada e posição sugerida no depósito.',
    page: '/demo/recebimento',
  ...
  },
  {
    ...
    title: 'Configuração do Pallet',
    description: 'Clique neste pallet para simular um ajuste na configuração. Você pode redistribuir produtos entre pallets.',
    page: '/demo/recebimento',
    targetElement: '[data-tutorial="pallet-individual"]',
    position: 'top',
    action: 'click',
    autoNavigation: false,
    modalTarget: true,
  ...
  {
    id: 'resumo-planejamento',
    title: 'Resumo do Planejamento',
    description: 'Esta área mostra o resumo total do planejamento: quantidade de pallets, produtos alocados e status geral.',
    page: '/demo/recebimento',
  ...
  },
  {
    ...
    description: 'Agora que você revisou todo o planejamento, clique em "Finalizar Planejamento" para confirmar a configuração dos pallets.',
    page: '/demo/recebimento',
