...
import SolicitacoesFilial from "./pages/SolicitacoesFilial";
...
import EditarTabelaFrete from "./pages/EditarTabelaFrete";
        ...
        <TooltipProvider>
          ...
          <Routes>
            ...
            <Route element={<RequireAuth><AppLayout /></RequireAuth>}>
              ...
              <Route path="funcionarios" element={<RequirePageAccess pageKey="funcionarios"><Funcionarios /></RequirePageAccess>} />
              ...
              <Route path="atendimento" element={<RequirePageAccess pageKey="atendimento"><Atendimento /></RequirePageAccess>} />
              ...
              <Route path="fornecedores" element={<RequirePageAccess pageKey="fornecedores"><Fornecedores /></RequirePageAccess>} />
              ...
              <Route path="embarques" element={<RequirePageAccess pageKey="embarques"><Embarques /></RequirePageAccess>} />
              ...
              {/* Rota de Tutorial */}
              <Route path="tutorial" element={<RequirePageAccess pageKey="tutorial"><Tutorial /></RequirePageAccess>} />
