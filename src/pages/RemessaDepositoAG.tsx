...
export default function RemessaDepositoAG() {
  ...
  // Filtrar apenas remessas para depósito (AG)
  const entradasFiltradas = entradas?.filter(e => 
    e.natureza_operacao?.toLowerCase().includes('remessa') && 
  ...
  const handleExport = () => {
    ...
    exportToCSV(csvData, 'remessa-deposito-ag');
  };
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Remessa para Depósito (AG)</h1>
          <p className="text-muted-foreground mt-2">
            Notas fiscais de remessa para armazém geral
          </p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <EmptyState
              title="Nenhuma remessa para depósito encontrada"
              description="Não há notas fiscais de remessa para armazém geral no período selecionado."
            />
          ) : (
