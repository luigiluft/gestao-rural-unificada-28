...
export default function RetornoFisico() {
  ...
  // Filtrar apenas retornos físicos
  const entradasFiltradas = entradas?.filter(e => 
    e.natureza_operacao?.toLowerCase().includes('retorno') && 
    e.natureza_operacao?.toLowerCase().includes('físico')
  ) || [];
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Retorno Físico</h1>
          <p className="text-muted-foreground mt-2">
            Notas fiscais de retorno físico de mercadorias
          </p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <EmptyState
              title="Nenhum retorno físico encontrado"
              description="Não há notas fiscais de retorno físico no período selecionado."
            />
          ) : (
