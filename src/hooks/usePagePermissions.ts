...
export interface PagePermission {
  page_key: string
  role: "admin" | "cliente" | "motorista" | "consumidor"
  can_access: boolean
...
export const useUpdatePagePermissions = () => {
  return async (updates: { page_key: string; role: "admin" | "cliente" | "motorista" | "consumidor"; can_access: boolean; visible_in_menu: boolean }[]) => {
