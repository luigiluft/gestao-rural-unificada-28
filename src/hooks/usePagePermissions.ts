...
export interface PagePermission {
  page_key: string
  role: "admin" | "operador" | "cliente" | "motorista"
  can_access: boolean
...
export const useUpdatePagePermissions = () => {
  return async (updates: { page_key: string; role: "admin" | "operador" | "cliente" | "motorista"; can_access: boolean; visible_in_menu: boolean }[]) => {
